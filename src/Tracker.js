...
class CalorieTracker{
    constructor(){
        ...
        this._meals = Storage.getMeals(); // add
        this._workouts = Storage.getWorkouts(); // take away
...
// Private Methods //
    ...
    _displayNewMeal(meal){
        const mealElements = document.getElementById('meal-items');
        ...
        `;
        mealElements.appendChild(mealElement)
    }
    _displayNewWorkout(workout){
        const workoutElements = document.getElementById('meal-items');
        ...
        `;
        workoutElements.appendChild(workoutElement)
    }
    _render(){
        this._displayCaloriesTotal();
        this._displayCaloriesConsumed();
